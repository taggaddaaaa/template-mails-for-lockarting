            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%"
                ...
                <tr>
                    <td valign="top" style="padding:9px" class="mcnImageGroupBlockInner">
                        ...
                        <table align="left" width="273" border="0" cellpadding="0"
                               cellspacing="0" class="mcnImageGroupContentContainer">
                            <tbody>
                            <tr>
                                <td class="mcnImageGroupContent" valign="top"
                                    style="padding-left: 9px; padding-top: 0; padding-bottom: 0;">
                                    <img alt=""
                                         src="img/announcement-sm1.png"
                                         width="264"
                                         style="max-width:264px; padding-bottom: 0;"
                                         class="mcnImage">
                                </td>
                            </tr>
                            </tbody>
                        ...
                        <table align="right" width="273" border="0" cellpadding="0"
                               cellspacing="0" class="mcnImageGroupContentContainer">
                            <tbody>
                            <tr>
                                <td class="mcnImageGroupContent" valign="top"
                                    style="padding-right: 9px; padding-top: 0; padding-bottom: 0;">
                                    <img alt=""
                                         src="img/announcement-sm1.png"
                                         width="264"
                                         style="max-width:264px; padding-bottom: 0;"
                            ...
                            <tr>
                                <td valign="top" class="mcnTextContent" style="padding: 0 18px 9px;">
                                    ...
                                    <p>Start by replacing the full-width header and main
                                        ...
                                        <a href="" class="mc-template-link" target="parent">solid color background</a>
                                        .
                                    </p>
                                </td>
                            </tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer"
                            ...
                            <tr>
                                <td align="center" valign="middle" class="mcnButtonContent"
                                    ...
                                    <a class="mcnButton " title="Find Out More" href="#" target="_blank"
