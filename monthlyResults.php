    ...
    <tr>
        <td style="vertical-align:top;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;">
                <tbody>
                <tr>
                    <td style="vertical-align:top; padding: 0 18px 18px;" align="center">
                        <table border="0" cellpadding="0" cellspacing="0"
                               style="border-collapse: separate !important;
                               border-radius: 3px;
                               background-image: linear-gradient(90deg, #FBC665 0%, #ECAF40 100%);
                               box-shadow: 0 0 4px 0 rgba(0,0,0,0.12), 0 4px 4px 0 rgba(0,0,0,0.24);">
                            <tbody>
                            <tr>
                                <td align="center" valign="middle"
                                    style="font-family: Helvetica,sans-serif; font-size: 18px; padding: 18px;">
                                    <a title="Find Out More" href="<?php //TODO:APPURL ?>"
                                       target="_blank"
                                       ...
                                       color: #FFFFFF;">Voir le classement</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
